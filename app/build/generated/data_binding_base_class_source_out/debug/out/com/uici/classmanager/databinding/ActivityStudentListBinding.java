...
public final class ActivityStudentListBinding implements ViewBinding {
  ...
  private ActivityStudentListBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton fabAddStudent, @NonNull RecyclerView recyclerViewStudents,
  ...
  public static ActivityStudentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStudentListBinding((ConstraintLayout) rootView, fabAddStudent,
          recyclerViewStudents, textViewEmpty, textViewTitle);
    }
